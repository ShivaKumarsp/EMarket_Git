...
@Component({
  selector: 'app-cancel-order-request',
  templateUrl: './cancel-order-request.component.html',
  styleUrls: ['./cancel-order-request.component.css']
})
export class CancelOrderRequestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let url='CancelOrderRequest/get_data/';
...
let url='CancelOrderRequest/update_order/';
