  ...
  constructor(private httpClient: HttpClient,
   ...
   private spinner:NgxSpinnerService) {
    this.customervalid = this.formBuilder.group({
      ...
      email: new FormControl('', [Validators.required, Validators.pattern(this.emailpat)]),
      phonenumber: new FormControl('', [Validators.required,Validators.pattern(this.phonepat),Validators.minLength(10)]),
      address: new FormControl('   ', [Validators.required]),
      countryid: new FormControl('', [Validators.required]),
      state: new FormControl('', [Validators.required]),
      city: new FormControl('', [Validators.required]),
      pincode: new FormControl('', [Validators.required,Validators.pattern(this.phonepat)]),
      ...
      profile: new FormControl('', [ 
        RxwebValidators.image({minHeight:50,minWidth:50, maxHeight:100,maxWidth:100 }),
